...
<div class="main w1200">
	...
	<div class="container fl">
		...
		<a isconvert="1" data-itemid="{$item.num_iid}" target="_blank" rel="nofollow"><img src="{:attach(get_thumb($item['pic_url'], '_b'),'item')}" alt="{$item.title}" /></a>
			</div>
			<div class="product-info fl">			
				<h3>       
		<a isconvert="1" data-itemid="{$item.num_iid}" target="_blank" rel="nofollow">{$item.title}</a>
				</h3>				
				<dl class="jp-size">
					<dt>宝贝属性：</dt>
					<dd>
				...
				<div class="item-btn clear">
					<span class="btn-tip fl">
                        <a isconvert="1" data-itemid="{$item.num_iid}" target="_blank" rel="nofollow" class="buybtn fl"><span>去抢购</span></a></if>
					</span>
				</div>			
      ...
      <div class="share_box pr fl">
		...
		<div class="share share_people" style="width:200px;left:10px;display:none;">
              ...
              <script type="text/javascript" src="__STATIC__/newpi/js/bd-share.js"></script>
          </div>
		</span>
		...
		<div class="product-comment">
			<div class="bady-tab" id="bady-tab">
				...
				<div class="gobuy fr" style="display: none; ">
					...
					<span class="tbuy">							
					<a isconvert="1" data-itemid="{$item.num_iid}" target="_blank" rel="nofollow" class="buybtn fl"><span>去抢购</span></a>			
					</span>              				
				</div>
			</div>

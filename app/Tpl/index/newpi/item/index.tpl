		...
		<div class="product clear">
			...
			<div class="product-info fl">
               ...
               <if condition="$item.cu eq ''"><else/><span class="my-like fl">{$item.cu}</span>	</if>				
				...
				<p class="fenxiang">
					<!--<div class="bdsharebuttonbox"><A class=bds_more href="http://share.baidu.com/code#" data-cmd="more"></A><A class=bds_mshare title=分享到一键分享 href="http://share.baidu.com/code#" data-cmd="mshare"></A><A class=bds_qzone title=分享到QQ空间 href="http://share.baidu.com/code#" data-cmd="qzone"></A><A class=bds_tsina title=分享到新浪微博 href="http://share.baidu.com/code#" data-cmd="tsina"></A><A class=bds_tqq title=分享到腾讯微博 href="http://share.baidu.com/code#" data-cmd="tqq"></A><A class=bds_renren title=分享到人人网 href="http://share.baidu.com/code#" data-cmd="renren"></A><A class=bds_weixin title=分享到微信 href="http://share.baidu.com/code#" data-cmd="weixin"></A><A class=bds_bdysc title=分享到百度云收藏 href="http://share.baidu.com/code#" data-cmd="bdysc"></A><A class=bds_tsohu title=分享到搜狐微博 href="http://share.baidu.com/code#" data-cmd="tsohu"></A><A class=bds_sqq title=分享到QQ好友 href="http://share.baidu.com/code#" data-cmd="sqq"></A><A class=bds_qq title=分享到QQ收藏 href="http://share.baidu.com/code#" data-cmd="qq"></A><A class=bds_t163 title=分享到网易微博 href="http://share.baidu.com/code#" data-cmd="t163"></A><A class=bds_copy title=分享到复制网址 href="http://share.baidu.com/code#" data-cmd="copy"></A></div>-->
                      <script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"{$item.title}","bdMini":"1","bdMiniList":false,"bdPic":"{$item.pic_url}","bdStyle":"0","bdSize":"32"},"share":{},"image":{"viewList":["mshare","qzone","tsina","tqq","renren","weixin","bdysc","tsohu","sqq","qq","t163","copy"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["mshare","qzone","tsina","tqq","renren","weixin","bdysc","tsohu","sqq","qq","t163","copy"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
				</p>
				<div class="other_info">
					<volist name="tags" id="tag">
							<a href="{:U('search/index',array('k'=>urlencode($tag)))}" target="_blank">{$tag}</a>
						</volist>
				</div>
			</div>
		</div>

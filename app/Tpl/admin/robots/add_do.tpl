...
<div class="subnav">
    <h1 class="title_2 line_x">添加采集器-阿里妈妈API2.0采集器</h1>
</div>
<div class="pad_lr_10" >
	...
	<table width="100%" cellspacing="0" class="table_form">
		...
		<tr class="tb_mod">
			...
			<br /></notempty>
			<input id="J_cid" name="cid" type="text" class="input-text" size="20" val="">
			此分类id作废不用填写，由于阿里妈妈API没有开放分类接口无法获取到。设置关键字采集即可</td>
		</tr>
		<tr>

        ...
        <tbody>
            <tr>
                ...
                <div class="explain_col">
					...
					&nbsp;&nbsp;分类 :
                    <select class="J_cate_select mr10" data-pid="0" data-uri="{:U('brand_cate/ajax_getchilds', array('type'=>0))}" data-selected="{$search.selected_ids}"></select>
